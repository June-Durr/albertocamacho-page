...
const Home = () => {
  ...
  // useEffect for handling menu toggle and navigation
  useEffect(() => {
    ...
    if (menuToggle && sideMenu && menuItems.length > 0) {
      ...
      // jQuery code to handle hamburger icon animation
    ...
    <>
      ...
      <div className="side-menu">
        ...
        <div className="menu-list-main">
          <ul>
            {/* Navigation links with click handlers and active link highlighting */}
            <li
        ...
        <div>
          <div id="wrap">
            <Link to="/" rel="noreferrer" target="_blank" className="btn-slide">
      ...
      <div className="main-containe" data-bs-spy="scroll">
          ...
          <div className="row">
            ...
            <div className="col-xxl-6 col-lg-6">
              ...
              <p className="best fade_down">
                I'm committed to providing top-quality service and building
                solutions that meet and exceed client needs. My dedication to
                excellence and continuous learning ensures I deliver the best
                possible results.
              </p>
        ...
        {/* <!-- ========SLIDER SECTION=================== Section Marquee ================SLIDER SECTION================ --> */}
        <section className="Marquee-main overflow-hidden">
          <h3 className="fade_up">Find Me On:</h3>
